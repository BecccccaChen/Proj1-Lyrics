...
```{r}
# load lyrics data
load('C:/Users/beca9/OneDrive/Desktop/5243/proj1/data/lyrics.RData') 
```
...
```{r export data}
save(dt_lyrics, file="C:/Users/beca9/OneDrive/Desktop/5243/proj1/output/processed_lyrics.RData")
```

```{r}
write.csv(dt_lyrics, "dt_lyrics.csv")
```
